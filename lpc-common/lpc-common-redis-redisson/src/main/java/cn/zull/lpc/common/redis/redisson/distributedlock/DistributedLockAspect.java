...
import cn.zull.lpc.common.redis.redisson.exception.DistributedLockException;
...
public class DistributedLockAspect {
    ...
    @Pointcut(value = "@annotation(cn.zull.lpc.common.redis.redisson.distributedlock.DistributedLockAnnotation)")
